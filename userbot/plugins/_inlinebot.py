...
async def inline_handler(event):
    ...
    if event.query.user_id == bot.uid and query.startswith("Friday"):
        ...
        result = builder.article(
            title="Stats",
            text=f"**Showing Stats For {DEFAULTUSER}'s Black Lightning** \nNote --> Only Owner Can Check This \n",
            buttons=[
        ...
        result = builder.photo(
            ...
            text=query,
            buttons=[
                [custom.Button.inline("I Will Do Spamming 😈 ", data="dontspamnigga")],
                [
                ...
                [custom.Button.inline("I Wanna Request Or Ask Something", data="askme")],
            ],
        )
        await event.answer([result])
...
async def on_plug_in_callback_query_handler(event):
    if event.query.user_id == bot.uid:  # pylint:disable=E0602
        ...
        reply_popp_up_alert = "What The Fuck Idoit,Fuck Off and don't use mine!"
...
async def on_plug_in_callback_query_handler(event):
    if event.query.user_id == bot.uid:  # pylint:disable=E0602
        ...
        reply_pop_up_alert = "What The Fuck Idoit,Fuck Off and don't use mine!!"
...
async def on_plug_in_callback_query_handler(event):
    if not event.query.user_id == bot.uid:
        sedok = "What The Fuck Idoit,Fuck Off and don't use mine!."
...
async def rip(event):
    ...
    text1 = "You Have Chosed A Probhited Option. Therefore, You Have Been Blocked By  Lightning. 🇮🇳"
...
def paginate_help(page_number, loaded_plugins, prefix):
    ...
    pairs = list(zip(plugins[::number_of_cols], plugins[1::number_of_cols]))
    if len(plugins) % number_of_cols == 1:
