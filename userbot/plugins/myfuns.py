...
@borg.on(lightning_cmd(pattern="mslap ?(.*)"))
async def who(event):
    if event.fwd_from:
        return
...
@borg.on(lightning_cmd(outgoing=True, pattern="mrape"))
...
@borg.on(lightning_cmd(outgoing=True, pattern="mshe"))
...
@borg.on(lightning_cmd(outgoing=True, pattern="mabuse"))
...
@borg.on(lightning_cmd(outgoing=True, pattern="mruns"))
async def fuckedd(abusehard):
...
@borg.on(lightning_cmd(outgoing=True, pattern="minsult$"))
async def proo(pros):
