...
CUSTOM_MIDDLE_PMP = (
    str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "Protection By  вℓα¢к ℓιgнтиιиg  🇮🇳"
)
USER_BOT_WARN_ZERO = "So Fuck You Have Attempted To Spam Masters Inbox So Inorder To Avoid Over Spam , You Have Been Blocked By Userbot"

botisnoob = Var.TG_BOT_USER_NAME_BF_HER

USER_BOT_NO_WARN = (
    "**Hello, This is  вℓα¢к ℓιgнтиιиg PM Protection Service ⚠️**\n\n"
...
async def hehehe(event):
    ...
    if event.is_private:
        if not pmpermit_sql.is_approved(chats.id):
            pmpermit_sql.approve(chats.id, "**Ooo Yeah He Is My Boss And He Is Best🔥**")
